import { ɵɵdefineInjectable, Injectable, ɵɵinject, NgZone, Component, Directive, ElementRef, Renderer2, HostListener, Input, NgModule } from '@angular/core';
...
PalettePickerService.ɵprov = ɵɵdefineInjectable({ factory: function PalettePickerService_Factory() { return new PalettePickerService(); }, token: PalettePickerService, providedIn: "root" });
...
PaletteTemplateService.ɵprov = ɵɵdefineInjectable({ factory: function PaletteTemplateService_Factory() { return new PaletteTemplateService(); }, token: PaletteTemplateService, providedIn: "root" });
...
class ThemeBuilderService {
    constructor(http, paletteTemplateService, localStorageService, palettePickerService, zone) {
        ...
        this.zone = zone;
        this.themeMode = true;
        this.Theme = new Subject$1();
        this.PaletteColors = new Subject$1();
    ...
    GetPalette(color) {
        ...
        const baseDark = this.multiply(tinyColor$1(color).toRgb(), tinyColor$1(color).toRgb());
...
ThemeBuilderService.ɵprov = ɵɵdefineInjectable({ factory: function ThemeBuilderService_Factory() { return new ThemeBuilderService(ɵɵinject(HttpClient), ɵɵinject(PaletteTemplateService), ɵɵinject(LocalStorageService), ɵɵinject(PalettePickerService), ɵɵinject(NgZone)); }, token: ThemeBuilderService, providedIn: "root" });
...
class VariantColorsComponent {
    ...
    computeColors(color) {
        ...
        const baseDarkColor = this.themeBuilderService.multiply(tinyColor$3(color).toRgb(), tinyColor$3(color).toRgb());
