(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('@lowcodeunit/lcu-theme-builder-common', ['exports', '@angular/core', '@angular/forms', '@angular/flex-layout', '@lcu/common', 'ngx-color-picker', 'rxjs/internal/Subject', 'rxjs/internal/BehaviorSubject', 'tinycolor2', 'rxjs', 'rxjs/operators', '@angular/common/http'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.lowcodeunit = global.lowcodeunit || {}, global.lowcodeunit['lcu-theme-builder-common'] = {}), global.ng.core, global.ng.forms, global.ng.flexLayout, global.common, global.ngxColorPicker, global.rxjs['internal/Subject'], global.rxjs['internal/BehaviorSubject'], global.tinycolor, global.rxjs, global.rxjs.operators, global.ng.common.http));
}(this, (function (exports, i0, forms, flexLayout, common, ngxColorPicker, Subject, BehaviorSubject, tinycolor, rxjs, operators, i1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var PalettePickerService = /** @class */ (function () {
        function PalettePickerService() {
            this.ColorPickerChanged = new BehaviorSubject.BehaviorSubject(new PaletteModel());
            this.ColorPickerClosed = new Subject.Subject();
        }
    ...
    var ThemeBuilderService = /** @class */ (function () {
        function ThemeBuilderService(http, paletteTemplateService, localStorageService, palettePickerService, zone) {
            this.http = http;
        ...
        ThemeBuilderService.prototype.GetPalette = function (color) {
            var baseLight = tinyColor$1('#ffffff');
            var baseDark = this.multiply(tinyColor$1(color).toRgb(), tinyColor$1(color).toRgb());
            var _a = __read(tinyColor$1(color).tetrad(), 4), baseTriad = _a[3];
            var primary = Object.keys(Constants.MIX_AMOUNTS_PRIMARY)
                .map(function (k) {
                var _a = __read(Constants.MIX_AMOUNTS_PRIMARY[k], 2), light = _a[0], amount = _a[1];
                return [k, tinyColor$1.mix(light ? baseLight : baseDark, tinyColor$1(color), amount)];
            });
            var accent = Object.keys(Constants.MIX_AMOUNTS_SECONDARY)
                .map(function (k) {
                var _a = __read(Constants.MIX_AMOUNTS_SECONDARY[k], 3), amount = _a[0], sat = _a[1], light = _a[2];
        ...
        ThemeBuilderService.prototype.multiply = function (rgb1, rgb2) {
            ...
            return tinyColor$1('rgb ' + rgb1.r + ' ' + rgb1.g + ' ' + rgb1.b);
        };
    ...
    var ColorPickerComponent = /** @class */ (function () {
        ...
        ColorPickerComponent.prototype.GetTextColor = function (col) {
            return tinyColor$2(col).isLight() ? '#000' : '#fff';
        };
    ...
    var SubPalettePickerComponent = /** @class */ (function () {
        function SubPalettePickerComponent(themeBuilderService, palettePickerService) {
            ...
            this.materialKeys = __spread(Object.keys(Constants.MIX_AMOUNTS_PRIMARY), Object.keys(Constants.MIX_AMOUNTS_SECONDARY));
        }
    ...
    var LightnessPickerComponent = /** @class */ (function () {
        ...
        LightnessPickerComponent.prototype.formSetup = function () {
            this.ToggleForm = new forms.FormGroup({
                toggle: new forms.FormControl(false)
            });
            this.onChanges();
        };
        LightnessPickerComponent.prototype.onChanges = function () {
            ...
            this.Toggle.valueChanges
                .subscribe(function (val) {
                _this.ToggleMode = val ? 'Light Mode' : 'Dark Mode';
                _this.themeBuilderService.ThemeMode = val;
            });
        };
    ...
    var VariantColorsComponent = /** @class */ (function () {
        function VariantColorsComponent(PalettePickerService, themeBuilderService) {
            this.PalettePickerService = PalettePickerService;
            this.themeBuilderService = themeBuilderService;
        ...
        VariantColorsComponent.prototype.ngOnInit = function () {
            ...
            this.paletteChangedSubscription = this.PalettePickerService.ColorPickerChanged
                ...
                _this.updateAccentColor(palette.accent.main);
                _this.updatePrimaryColor(palette.primary.main);
                _this.updateWarnColor(palette.warn.main);
            });
        };
        VariantColorsComponent.prototype.ngOnDestroy = function () {
            this.paletteChangedSubscription.unsubscribe();
        };
        VariantColorsComponent.prototype.updatePrimaryColor = function (color) {
            var e_1, _a;
        ...
        VariantColorsComponent.prototype.updateAccentColor = function (color) {
            var e_2, _a;
        ...
        VariantColorsComponent.prototype.updateWarnColor = function (color) {
            var e_3, _a;
        ...
        VariantColorsComponent.prototype.computeColors = function (color) {
            var baseLightColor = tinyColor$3('#ffffff');
            var baseDarkColor = this.themeBuilderService.multiply(tinyColor$3(color).toRgb(), tinyColor$3(color).toRgb());
            var _a = __read(tinyColor$3(color).tetrad(), 4), baseTetrad = _a[3];
            return [
        ...
        // force change
        VariantColorsComponent.prototype.getColorObject = function (value, name) {
            var c = tinyColor$3(value);
            return {
                name: name,
                hex: c.toHexString(),
    ...
    var ThemePickerComponent = /** @class */ (function () {
        function ThemePickerComponent(palettePickerService, themeBuilderService) {
            this.palettePickerService = palettePickerService;
            this.themeBuilderService = themeBuilderService;
            this.setupForm();
            this.themes();
    ...
    exports.ɵb = PalettePickerComponent;
    exports.ɵc = PaletteTemplateService;
    exports.ɵd = LocalStorageService;
    exports.ɵe = SubPalettePickerComponent;
    exports.ɵf = LightnessPickerComponent;
    exports.ɵg = VariantColorsComponent;
    exports.ɵh = ThemePickerComponent;
