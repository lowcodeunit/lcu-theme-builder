(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@angular/flex-layout'), require('@lcu/common'), require('ngx-color-picker'), require('rxjs'), require('tinycolor2'), require('rxjs/operators'), require('@angular/common/http')) :
    typeof define === 'function' && define.amd ? define('@lowcodeunit/lcu-theme-builder-common', ['exports', '@angular/core', '@angular/forms', '@angular/flex-layout', '@lcu/common', 'ngx-color-picker', 'rxjs', 'tinycolor2', 'rxjs/operators', '@angular/common/http'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.lowcodeunit = global.lowcodeunit || {}, global.lowcodeunit['lcu-theme-builder-common'] = {}), global.ng.core, global.ng.forms, global.ng.flexLayout, global.common, global.ngxColorPicker, global.rxjs, global.tinycolor, global.rxjs.operators, global.ng.common.http));
}(this, (function (exports, i0, forms, flexLayout, common, ngxColorPicker, rxjs, tinycolor, operators, i1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var VariantColorsComponent = /** @class */ (function () {
        ...
        VariantColorsComponent.prototype.computeColors = function (color) {
            var baseLightColor = tinyColor('#ffffff');
            var baseDarkColor = this.themeBuilderService.multiply(tinyColor(color).toRgb(), tinyColor(color).toRgb());
            var _a = __read(tinyColor(color).tetrad(), 4), baseTetrad = _a[3];
            return [
